...
def generate_report(handler, students_score, total_score, school_name, class_name):
    ...
    return report_type_fuc[handler.report_type](handler, students_score, total_score, school_name, class_name)
...
def generate_report_v1(handler,  students_score, total_score, school_name, class_name):
    students_score.sort(key=lambda x: x['score'], reverse=True)
